...
const middleRow = (game: Game): WinnerResult => {
    if (game.middleLeft !== '' && game.middleLeft === game.middleCenter && game.middleCenter == game.middleRight) {
...
const bottomRow = (game: Game): WinnerResult => {
    if (game.bottomLeft !== '' && game.bottomLeft === game.bottomCenter && game.bottomCenter == game.bottomRight) {
...
const leftColumn = (game: Game): WinnerResult => {
    if (game.topLeft != '' && game.topLeft === game.middleLeft && game.middleLeft == game.bottomLeft) {
        return game.topLeft;
    }
    return null;
};
...
const centerColumn = (game: Game): WinnerResult => {
    if (game.topCenter !== '' && game.topCenter === game.middleCenter && game.middleCenter == game.bottomCenter) {
...
const rightColumn = (game: Game): WinnerResult => {
    if (game.topRight !== '' && game.topRight === game.middleRight && game.middleRight == game.bottomRight) {
...
const diagonalTopLeftBottomRight = (game: Game): WinnerResult => {
    if (game.topLeft !== '' && game.topLeft === game.middleCenter && game.middleCenter === game.bottomRight) {
        return game.topLeft;
    }
    return null;
};
...
const diagonalBottomLeftTopRight = (game: Game): WinnerResult => {
    if (game.bottomLeft !== '' && game.bottomLeft === game.middleCenter && game.middleCenter === game.topRight) {
        return game.bottomLeft;
    }
    return null;
};
